      ...
      <View style={styles.container}>
        ...
        <View style={styles.container1}>
          ...
          <Text style={styles.switchtext}>
            Offer For Adoption {datainfo.petType}
          </Text>
          <Switch
            style={styles.switch1}
            value={isSwitchOn1}
          ...
          />
          <Text style={styles.switchtext}>
            Offer For Breeding {datainfo.petType}
          </Text>
        </View>
        <Text style={styles.descrptiontitle}> Descrption </Text>
        <Text style={styles.descrption}>
          Despite my dog leaning on me each time we meet other big dogs in the
          street, I am certain his/her lean nature is an advantage when I am not
          present
        </Text>
      </View>
    </SafeAreaView>
