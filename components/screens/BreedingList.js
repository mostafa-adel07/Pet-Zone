...
export const BreedingList = ({ route, navigation }) => {
  ...
  function Apply() {
    ...
    var string2 = "";
    {
      ...
      petBreed == ""
        ? null
        : isfull == false && petColor == "" && petGender == ""
        ? (string2 = "?petBreed=" + petBreed)
        : (string2 = "&petBreed=" + petBreed);
    }
  ...
  /*function selectpet(){
  //setisselected(true)
  navigation.navigate('SelectedBreedPet')
}*/
      ...
      {shouldShow ? (
        <SafeAreaView style={styles.container1}>
          <View style={styles.header1}>
            <Text style={styles.textheader1}>Breeding</Text>
          </View>
              ...
              renderItem={({ item }) => {
                return (
                  <Card
                    style={styles.card}
                    onPress={() => {
                      navigation.navigate("SelectedBreedPet", { id: item._id });
                    }}
                  >
                    <Card.Cover
                      key={item.petName}
