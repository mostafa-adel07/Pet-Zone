...
const styles = StyleSheet.create({
 card:{backgroundColor:"rgb(250, 219, 216)",marginBottom:30, marginLeft:"2%",width:"96%",height:170},
 cover:{width:"40%",height:170,padding:2,backgroundColor:"rgb(250, 219, 216)"},
 title:{paddingBottom:10, marginLeft:200,bottom:160, fontWeight:"bold", fontSize:16},
 buttoncontainer1:
 {
